        ...
        <div className="content-container-bar">
          <div className="content-container-left">
            ...
            <article className="contact-container-text">
              <h3 className="contact-container-hight-text">
                <AiTwotonePhone /> Zavolejte nám
              </h3>
            ...
            <article className="contact-container-text">
              ...
              <div className="contact-bar">
                <strong>Dominik Helešic: </strong>
                <a href="mailto:dominikhelesic@fezzy.cz">
                  dominikhelesic@fezzy.cz
                </a>
              </div>
              <div className="contact-bar">
            ...
            <article className="contact-container-text">
              <h3 className="contact-container-hight-text">
                {" "}
                <IoInformationCircleSharp /> Ostatní informace
              </h3>
              <div className="contact-bar">
                <strong>IČO: </strong>
          ...
          <div className="content-container-right">
            <div className="content-container-right-item">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2536.590251302835!2d14.196507537813371!3d49.126194512224494!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4774ab58d6f37d91%3A0x805fb05ebd5d06c!2zw5pqZXpkLCAzODkgMDEgVm9kxYhhbnksIMSMZXNrbw!5e0!3m2!1ssk!2ssk!4v1676313965264!5m2!1ssk!2ssk"
                allowfullscreen=""
                loading="lazy"
