...
window.addEventListener("scroll", showButton)
    ...
    return(
        <button className="back-to-home-button-container">
            <Link activeClass="active" to="nav" spy={true} smooth={true} offset={50} duration={500}>
                <IoHomeSharp className={ backToHomeButton? "back-to-home-button back-to-home-button-show" : "back-to-home-button"  } />
            </Link>
        </button>
    )
}