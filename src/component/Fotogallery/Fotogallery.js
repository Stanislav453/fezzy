...
import data from "./FotogalleryData";
import fezzyLogo from "./fezzy-foto-gallery.png";
        ...
        <section className="container fotogallery-bg">
            {
                ...
                <div className="modal-box">
                    <div className="modal-box-content">
                        <button onClick={ () => imgAction() } className="modal-box-close"><AiFillCloseSquare /> </button>
                        <button onClick={ () => imgAction("prev-img") } className="modal-box-next-left"><BsArrowLeftSquareFill /></button>
                        <img className="image-modal-box" src={viewerImage.img} alt="photo"/>
                        <button onClick={ () => imgAction("next-img") } className="modal-box-next-right"><BsFillArrowRightSquareFill /> </button>
                    </div>
                </div>
            }
